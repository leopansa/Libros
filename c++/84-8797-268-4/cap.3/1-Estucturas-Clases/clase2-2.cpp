...
// Constructor
// [ : ] Luego de la funcion indican que es una lista de inicializadores
...
int main()
{
    CFecha hoy;
    VisualizarFecha(hoy);
    hoy = CFecha(15); // crear e inicializar el objeto hoy
    VisualizarFecha(hoy);
    hoy = CFecha(15,2); // crear e inicializar el objeto hoy
    VisualizarFecha(hoy);
    hoy = CFecha(15,2,2021); // crear e inicializar el objeto hoy
    VisualizarFecha(hoy);
